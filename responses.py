...
physical_activity_responses = {
    "decrease": [
            ...
            "Consider incorporating periods of lighter training, such as active recovery days or deload weeks.",
            "Include activities that are less physically demanding, such as yoga, meditation, or stretching.",
            ...
            "Ensure you are getting adequate and quality sleep, as it plays a crucial role in recovery."
            "Lack of sleep can contribute to increased stress on the body.",
            "Incorporate stress-reducing activities into your routine, such as mindfulness, deep breathing, or hobbies.",
...
temperature_responses = {
    ...
    "decrease": [
        ...
        "Exercise in less physically demanding ways or swim in cool water to prevent overheating.",
...
sleep_time_responses = {
    "increase": [
            "Avoid caffeine, alcohol, nicotine, and other chemicals that interfere with sleep, especially in the afternoon and evening.",
            "Turn your bedroom into a sleep-inducing environment, with room-darkening shades, earplugs, a fan, or other devices that suit your needs.",
            "Establish a soothing pre-sleep routine, such as taking a warm bath, doing calming activities, or listening to binaural beats.",
            "Go to sleep when you’re truly tired and maintain a set sleep schedule.",
            "Dedicate time to self-care, such as yoga, meditation, journaling, reading, or listening to relaxing music.",
        ],
    "reduce": [
